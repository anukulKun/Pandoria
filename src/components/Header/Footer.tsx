...
const Footer = () => {
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <h3 className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-8 text-[17vw] font-black tracking-tighter leading-none m-0 p-0 whitespace-nowrap">PANDORIA</h3>
    </section>
  );
};
